...

{
  ...
  fileSystems."/" =
    { device = "/dev/disk/by-uuid/90267e04-6cfc-4639-b46f-284183a0a4cb";
      fsType = "ext4";
    };

  fileSystems."/boot" =
    { device = "/dev/disk/by-uuid/B6B4-60DC";
      fsType = "vfat";
    };

  swapDevices =
    [ { device = "/dev/disk/by-uuid/f60466af-8d8c-4c59-abac-964ab208d2fc"; }
    ];
