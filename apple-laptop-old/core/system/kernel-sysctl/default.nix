...
# Kernel tweaks
{
  boot.kernel.sysctl = {
    ...
    "net.core.rmem_default" =
      131072; # Default socket receive buffer size, improve network performance & applications that use sockets
    "net.core.rmem_max" =
    ...
    "net.core.wmem_default" =
      131072; # Default socket send buffer size, improve network performance & applications that use sockets
    "net.core.wmem_max" =
    ...
    "net.ipv4.ipfrag_high_threshold" =
      8388608; # Reduce the chances of fragmentation
    ...
    "vm.swappiness" =
      10; # how aggressively the kernel swaps data from RAM to disk. Lower values prioritize keeping data in RAM,
    "vm.vfs_cache_pressure" =
      80; # Adjust vfs_cache_pressure (0-1000), how the kernel reclaims memory used for caching filesystem objects
  };
