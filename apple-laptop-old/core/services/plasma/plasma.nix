  ...
  programs.plasma = {
    ...
    configFile = {
      ...
      "dolphinrc"."kuick-copy"."Paths[$e]" =
        "smb://tolga@192.168.0.11/Documents,/run/media/tolga/20C1-81FF,/run/media/tolga/Ventoy/WINDOWS,$HOME/Developments/,$HOME/Development/NixOS/,$HOME/Documents/";
      "dolphinrc"."kuick-move"."Paths[$e]" =
        "$HOME/Desktop/,$HOME/Developments/MyGitHub/,$HOME/Desktop/nixos github master/NixOS-tolga-main/SCRIPTS/";
      "kactivitymanagerdrc"."activities"."a886da9a-fb7e-4588-b5ab-86928caef2e8" =
        "Default";
      "kactivitymanagerdrc"."main"."currentActivity" =
        "a886da9a-fb7e-4588-b5ab-86928caef2e8";
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid" =
        "{6bdbe264-214e-4fa8-b5ab-17c7cf5e5933}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid" =
        "{c4077428-be8c-44f8-b328-8d79f059140b}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid" =
        "{9e434371-cc88-413e-a9b3-bb4ef8f30d54}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid" =
        "{91f33331-a2a9-474b-bc04-48e17cbc2600}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid" =
        "{6572d3b6-a952-4fb7-84e1-329269b5389c}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid" =
        "{4b3702ae-7879-4638-a49f-b35f1db211b8}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid" =
        "{81a8e421-1775-4780-98ab-96cfc8bd7760}";
