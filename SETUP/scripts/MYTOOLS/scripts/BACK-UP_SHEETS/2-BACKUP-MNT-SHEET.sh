...
sudo mount -t cifs -o username=brian,password=111211,vers=3.0 "$backup_DST" /mnt/nixos_share
...
echo "Mount command: sudo mount -t cifs -o username=brian,password=111211,vers=3.0 $backup_DST /mnt/nixos_share"
